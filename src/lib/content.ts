...
const EN: Dict = {
  ...
  technical: [
    ...
    { n: 100, suf: "", l: "SEO", d: "Semantic markup, structured data & metadata that ranks", meter: 100 },
...
const BG: Dict = {
  ...
  technical: [
    ...
    { n: 100, suf: "", l: "SEO", d: "Семантичен markup, структурирани данни и метаданни, които класират", meter: 100 },
